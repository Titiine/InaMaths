...
const fr = {
  ...
  tables_title: 'Mes tables de multiplication',
  tables_train: 'S\'entraîner',
  tables_intro: 'On travaille surtout les tables que tu connais le moins !',
  tables_legend_known: 'Su',
  tables_legend_fluctuating: 'Fluctue',
  tables_legend_weak: 'À travailler',
  tables_legend_new: 'Nouveau',
  tables_mastered: 'Tables sues',
  tables_priority: 'À revoir en priorité',
  tables_none_priority: 'Rien à revoir pour l\'instant, bravo ! 🎉',
  tables_reset: 'Tout remettre à zéro',
  tables_grid_hint: 'Chaque case : une multiplication. La couleur montre si tu la sais.',
  tables_trend_up: 'en progrès',
...
const en: typeof fr = {
  ...
  tables_title: 'My multiplication tables',
  tables_train: 'Practise',
  tables_intro: 'We mostly practise the tables you know the least!',
  tables_legend_known: 'Known',
  tables_legend_fluctuating: 'Shaky',
  tables_legend_weak: 'To work on',
  tables_legend_new: 'New',
  tables_mastered: 'Tables known',
  tables_priority: 'Review first',
  tables_none_priority: 'Nothing to review yet, well done! 🎉',
  tables_reset: 'Reset everything',
  tables_grid_hint: 'Each cell is a multiplication. The colour shows if you know it.',
  tables_trend_up: 'improving',
